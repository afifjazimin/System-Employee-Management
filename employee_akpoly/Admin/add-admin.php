      ...
      <div class="container-fluid">
        <div class="admin-page-header">
          <div>
            ...
            <p class="admin-page-copy">Add a new administrator profile with account details, phone number, and a profile image.</p>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </div>
           ...
           <div class="form-group">
                    ...
                    <p class="text-center">
                      <span class="admin-avatar-preview">
                        <img src="../<?php echo $admin_photo; ?>" alt="user image" id="logo-img">
                      </span>
				    </p>
              </div>
